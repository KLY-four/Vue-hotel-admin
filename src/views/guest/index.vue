<template>
  <el-card class="box-card" shadow="always">
    <div slot="header">
      <span>客户信息管理</span>
      <el-button type="primary" style="float: right; padding: 6px 12px" ><input type="number" v-model="phone" style="border: 0;outline: none" placeholder="根据电话号码查询用户">&nbsp;&nbsp;&nbsp;<span @click="getDataByPhone">搜索</span></el-button>
    </div>
    <el-table
      ref="multipleTable"
      :loading="listLoading"
