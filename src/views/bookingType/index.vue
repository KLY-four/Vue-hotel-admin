...
<script>
import {getAllOrderType, delOrderType,addOrderType,getOrderTypeById,updateOrderType,batchDelBookingType } from "../../api/bookingType";
...
export default {
  ...
  methods: {
    ...
    batchDeletion: function () {
      ...
      batchDelBookingType(array).then((res)=>{
        if (res.code === 1000) {
          this.$message({
            message: '删除成功！',
            type: 'success'
