  ...
  <el-card class="app-container" shadow="always">
    ...
    <el-form ref="form1" :model="form1" label-width="120px">
      <el-form-item
        ...
        label="预订方式">
        <el-select v-model="form1.orderType" :change="idToType(form1.orderType)" placeholder="请预定方式">
      ...
      <el-form-item
        ...
        label="是否有窗">
        <el-radio v-model="form1.chuanghu" :label="windowSwitch.has">有窗</el-radio>
        <el-radio v-model="form1.chuanghu" :label="windowSwitch.none">没有窗</el-radio>
      </el-form-item>
      <el-form-item
        :rules="[
          { required: true, message: '不能为空'},
    ...
    methods: {
      ...
      idToType(val) {
        ...
        this.typeList.forEach(type => {
          if (val === type.orderId) {
            this.form1.orderType = type.orderType
          }
        })
      },
      onSubmit() {
